<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreatedRented.aspx.cs" Inherits="MediaStoreWebApp.CreatedRented" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3">
                <asp:Button ID="_btnCreateMovie" Width="100%" runat="server" Cssclass="btn btn-primary" Text="Add Movie To Rent" Font-Bold="True" OnClick="_btnCreateRentedMovie_Click" />
            </div>
        </div>
    </div>
</asp:Content>
