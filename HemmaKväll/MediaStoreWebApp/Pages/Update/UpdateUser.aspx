<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="MediaStoreWebApp.UpdateUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3">
                <asp:Button ID="_btnCreateUser" runat="server" Cssclass="btn btn-primary" Text="Save Changes" Font-Bold="True" OnClick="_btnUpdateUser_Click" />
            </div>
        </div>
    </div>
</asp:Content>
