<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateMovie.aspx.cs" Inherits="MediaStoreWebApp.UpdateMovie" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3">
                <asp:Button ID="_btnUpdateMovie" runat="server" Cssclass="btn btn-success" Text="Update" Font-Bold="True" OnClick="_btnUpdateMovie_Click" />
            </div>
        </div>
        </div>
    </div>
